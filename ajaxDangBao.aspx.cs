...
namespace BTL_Web_TinTuc_NangCao
{
    public partial class ajax : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // gán data vào Báo 
            if (Request.Form["inputContent"] != null && Request.Form["inputTitle"] != null && Request.Form["inputTheLoai"] !=null)
            {
                bao.tacgia = "admin";
            ...
            if (Request.Files["inputImage"] != null)
            {
            ...
            //capnhatdanhsach
            if(Request.QueryString["idTheLoai"] != null)
            {
                bao.getTheloaiBao_ID(int.Parse(Request.QueryString["idTheLoai"].ToString()));
                JavaScriptSerializer serializer = new JavaScriptSerializer();
                string json = serializer.Serialize(bao);
                Response.Write(json);
                Response.ContentType = "application/json; charset=utf-8";
