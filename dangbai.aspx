...
>
  ...
  <div style="display: flex;">
    ...
    <span ClientIDMode="Static" ID="count" runat="server"></span>
    <span>&nbsp; bài báo</span>
  </div>
    <span>Thể loại:</span>
    <select id="theloaiList" ClientIDMode="Static" runat="server">
  ...
  <script>
    ...
    inputTitle.addEventListener("change", function () {
      ...
      const theloaiList = document.getElementById("theloaiList");

      theloaiList.addEventListener("change", () => {
          const xhttp = new XMLHttpRequest();
          xhttp.open("get", "ajaxDangBao.aspx?idTheLoai=" + theloaiList.value, true);
          xhttp.send()
      })
